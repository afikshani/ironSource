...
module.exports = {
    ...
    myTweets: function(res, client, count) {
        ...
        client.get('statuses/user_timeline', queryParams, function (error, tweets, response){
            if (!error) { // Get the tweets as a JSON and send back to the tester
                ...
                res.write(`These are the ${queryParams.count} most recent Tweets of you [JSON FORMAT] : \n\n`)
     ...
     * The method provide a list of Tweets containing or related to the sent keyword and 'likes' a random tweet out of this list.
     */
